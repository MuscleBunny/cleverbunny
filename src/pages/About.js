  ...
  return (
    <CustomCard actions={[]}>
      ...
      <CardContent sx={{width:'100%'}}>
        ...
        Who am I?<br/>
        As a full-stack developer, Akira has a great breadth and depth of experience in web development.<br/>
        He is experienced with many frameworks and databases<br/>
